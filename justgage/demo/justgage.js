JustGage = function(config) {
  ...
  obj.config = {
    ...
    // reverse : bool
    // reverse min and max
    reverse: obj.kvLookup('reverse', config, dataset, false),
    ...
    // pointer : bool
    // show value pointer
    pointer: obj.kvLookup('pointer', config, dataset, false),

    // pointerOptions : object
    // define pointer look
    pointerOptions: obj.kvLookup('pointerOptions', config, dataset, [])
  };
